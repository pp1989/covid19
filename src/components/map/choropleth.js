  ...
  return (
    <div className="full-width-height container">
      ...
      <div className="center">
        <button className="mt16" style={{ margin: "50px 520px", fontVariantCaps: "petite-caps", fontStyle: "oblique", fontWeight: "bold" }} onClick={onChangeButtonClick}>Colour Changer</button>
      </div>
    </div>
  );
}
